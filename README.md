...
cd python-alexa-voice-servicepython3 -m venv venv
...
python3 -m venv venv
source venv/bin/activate   # en Linux/Mac
venv\Scripts\activate      # en Windowspip install -r requirements.txtpip install git+https://github.com/Lukasa/hyper.gitcp config_example.dict config.dict{
  ...
  "client_secret": "TuClientSecret",
  "refresh_token": ""
}cp config_example.dict config.dictpip install git+https://github.com/Lukasa/hyper.gitpip install -r requirements.txtpython3 -m venv venv
source venv/bin/activate   # en Linux/Mac
venv\Scripts\activate      # en Windows# Python Alexa Voice Service
...
───────────────────────────────────────────────https://developer.amazon.com/alexa/console/askhttps://ef3a06ef-1ddd-41c5-af62-593ce4cd78ca-00-29kex9t854qgi.picard.replit.devconst https = require("https");
